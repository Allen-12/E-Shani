                ...
                <li>
                  ...
                  <div class="uk-card uk-card-default uk-card">
                      <div class="uk-card-media-top">
                        <a href="#"> <img src="https://images.unsplash.com/photo-1603712313678-07e4105c3e85?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60" alt=""></a>
                      </div>
                      <div class="uk-card-body">
                    <h3> <a href="/profiles/{{ $child->id }}/show">{{ $child->name }}</a></h3>
                      <a data-toggle="modal" data-target="#edituser" style="color:#00BCD4">  <span uk-icon="pencil">Edit User</span></a>
                    </div>
                    </div>
                      </div>
                </li>
